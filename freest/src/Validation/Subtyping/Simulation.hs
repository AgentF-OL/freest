...
module Validation.Subtyping.Simulation
  ( Node(..)
  , PairExpander
  , expand 
  , reflex 
...
import           Validation.Subtyping.Norm
...
findInAncestors :: Ancestors -> Nonterminal -> Nonterminal -> Maybe (Word, Word)
...
findInPair :: (Word, Word) -> Nonterminal -> Nonterminal -> Maybe (Word, Word)
...
gammaBPA2 :: Productions -> Nonterminal -> Nonterminal -> Maybe Word
...
throughPath :: Productions -> [Terminal] -> Word -> Maybe Word
