...
module Validation.Subtyping.Norm
( normed
, norm
, allNormed
, equallyNormed
...
import           Validation.Subtyping.Grammar (Word, Productions, Terminal, transitions)
...
maybeNorm p = norm Set.empty
  ...
  norms :: Visited -> Word -> Map.Map Terminal (Maybe Int)
